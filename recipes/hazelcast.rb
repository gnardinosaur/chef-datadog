...
#   "instances" => [
#     {
#       # mc_health_check_endpoint - required: false  - string
#       "mc_health_check_endpoint" => nil,
#       # mc_cluster_states - required: false  - object
#       "mc_cluster_states" => {
#         "Active" => "OK",
